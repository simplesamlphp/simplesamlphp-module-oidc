...
/**
 * @covers \SimpleSAML\Module\oidc\Controller\ClientShowController
 *
 * @backupGlobals enabled
 */
class ClientShowControllerTest extends TestCase
{
    /**
    ...
    protected function getStubbedInstance(): ClientShowController
    {
        return new ClientShowController(
    ...
    {
        $this->assertInstanceOf(ClientShowController::class, $this->getStubbedInstance());
    }
