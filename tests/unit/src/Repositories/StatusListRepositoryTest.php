...
class StatusListRepositoryTest extends TestCase
{
    ...
    public function testDeactivatesListsCreatedUnderASupersededPolicy(): void
    {
        ...
        $this->assertSame(1, $this->repository->deactivateSuperseded([self::POOL_ID => 'the-current-policy']));
    ...
    public function testLeavesListsOfTheCurrentPolicyActive(): void
    {
        ...
        $this->assertSame(0, $this->repository->deactivateSuperseded([self::POOL_ID => self::POLICY]));
    ...
    public function testDeactivatesListsOfAPoolWhichIsNoLongerConfigured(): void
    {
        ...
        $this->assertSame(1, $this->repository->deactivateSuperseded([self::POOL_ID => self::POLICY]));
    ...
    public function testLeavesListsWhichAreStillBeingSeededAlone(): void
    {
        ...
        $this->assertSame(0, $this->repository->deactivateSuperseded([self::POOL_ID => 'the-current-policy']));
